...
import v3Serialization = require('city/serialization/v3-serialization-format');
...
var isV3         = (x: any): x is v3Serialization.CityData => x.version === 3;

// Per-source migration steps, for each possible source

var migrateFromV2 = (data: v2Serialization.CityData) => _.merge(_.cloneDeep(data), {
